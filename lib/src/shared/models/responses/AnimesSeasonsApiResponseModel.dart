...
/// id : 93614
/// anime_episode_id : 39500
/// server : "480p"
/// header : "https://miravd.com/"
/// useragent : null
/// link : "https://miravd.com/embed-k9j0p5laefml.html"
/// lang : "Arabic"
/// video_name : null
/// embed : 0
/// youtubelink : 0
...
class Videos {
  Videos({
      ...
      String? updatedAt,}){
    _id = id;
    _animeEpisodeId = animeEpisodeId;
    _server = server;
    _header = header;
  ...
  Videos.fromJson(dynamic json) {
    _id = json['id'];
    _animeEpisodeId = json['anime_episode_id'];
    _server = json['server'];
    _header = json['header'];
...
Videos copyWith({  num? id,
  ...
  animeEpisodeId: animeEpisodeId ?? _animeEpisodeId,
  ...
  num? get id => _id;
  num? get animeEpisodeId => _animeEpisodeId;
  ...
  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    map['id'] = _id;
    map['anime_episode_id'] = _animeEpisodeId;
    map['server'] = _server;
    map['header'] = _header;
