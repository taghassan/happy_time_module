...
class PlusCurvedBottomNavBar extends StatefulWidget {
  const PlusCurvedBottomNavBar({super.key});

  @override
  _BottomNavBarCurvedFb1State createState() => _BottomNavBarCurvedFb1State();
}

class _BottomNavBarCurvedFb1State extends State<PlusCurvedBottomNavBar> {
